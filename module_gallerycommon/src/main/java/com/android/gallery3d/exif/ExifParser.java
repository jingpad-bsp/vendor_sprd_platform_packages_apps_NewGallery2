...
class ExifParser {
    ...
    private ExifTag readTag() throws IOException, ExifInvalidFormatException {
        ...
        if (dataSize > 4) {
            ...
            // Read the data here.
            /* SPRD: fix bug 380719,invalid jpeg @{ */
    ...
    protected void readFullTagValue(ExifTag tag) throws IOException {
        ...
        switch (tag.getDataType()) {
            ...
            case ExifTag.TYPE_UNSIGNED_SHORT: {
                /* @ Bug 1432636，prevent the value get from getComponentCount is huge, which cause the OOM*/
                int length = tag.getComponentCount() > 1024 ? 1024 :tag.getComponentCount();
