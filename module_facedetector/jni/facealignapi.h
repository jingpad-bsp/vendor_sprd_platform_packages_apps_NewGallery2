...
#define FA_SHAPE_POINTNUM  28 /* Number of vertex on the face shape 68/28/12/7*/
...
/* Solve the face pose based on 7 key landmarks*/
FAAPI(int) FaSolvePose(FA_ALIGN_HANDLE hFA,
                       FA_SHAPE *i_shape,
                       FA_POSE *o_pose);
