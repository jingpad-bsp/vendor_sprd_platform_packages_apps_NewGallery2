        ...
        public ImageHolder(View itemView) {
            ...
            mContainer.setOnLongClickListener(new OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    ...
                    } else if (mSelectionMode == ActionModeHandler.ENTER_SELECTION_MODE) {
                    ...
                    // jingos add picture drag function
                    ClipData.Item item = new ClipData.Item(imageItem.getUri());
                    Log.d(TAG, "onLongClick: imageItem.getUri() = " + imageItem.getUri());
                    ClipData dragData = new ClipData(
                            (CharSequence) v.getTag(),
                            new String[] { ClipDescription.MIMETYPE_TEXT_PLAIN },
                            item);

                    View.DragShadowBuilder viewShadow = new DragShadowBuilder(mContainer);

                    v.startDragAndDrop(dragData, viewShadow, null, View.DRAG_FLAG_GLOBAL);
                    return false;
                }
            });
        }
