...
public class Wallpaper extends Activity {
    ...
    private static final int STATE_SELECT_PHOTO = 0;
    ...
    protected void onResume() {
        super.onResume();
//        boolean result = GalleryUtils.killActivityInMultiWindow(this, GalleryUtils.DONT_SUPPORT_VIEW_PHOTOS);
//        if (result) {
//            return;
//        }
        ...
        switch (mState) {
            case STATE_INIT: {
                ...
                if (mPickedItem == null) {
                    Intent request = new Intent(Intent.ACTION_GET_CONTENT)
                            .setClass(this,
                                    GalleryUtils.isSupportV2UI() ? com.android.gallery3d.v2.widget.DialogPicker.class :
                                            DialogPicker.class)
                            .setType(IMAGE_TYPE);
                    startActivityForResult(request, STATE_PHOTO_PICKED);
                    mState = STATE_SELECT_PHOTO;
                    return;
                }
            ...
            case STATE_PHOTO_PICKED: {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                    ...
                    mPickedItem = GalleryUtils.transFileToContentType(mPickedItem, Wallpaper.this);
                    try {
