...
//        GalleryUtils.killActivityInMultiWindow(this, GalleryUtils.DONT_SUPPORT_VIEW_VIDEO);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_MENU && mPlayer != null && mPlayer.isLock()) {
            return true;
        }else if (keyCode == KeyEvent.KEYCODE_ESCAPE && mPlayer != null)
        {
            if (!getIsFullScreen()) {
                onBackPressed();
                return true;
        ...
        else if (keyCode == KeyEvent.KEYCODE_ENTER && mPlayer != null)
        {
            if (getIsFullScreen()) {
                setIsFullScreen(false);
            }
        ...
        else if (keyCode == KeyEvent.KEYCODE_SPACE && mPlayer != null)
        {
            mPlayer.onPlayPause();
            return true;
        }
