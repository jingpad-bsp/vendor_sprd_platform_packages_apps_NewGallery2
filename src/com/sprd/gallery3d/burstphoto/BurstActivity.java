...
public class BurstActivity extends Activity {
    ...
    private int handleIntent() {
        ...
        if (intent != null) {
            ...
            int bucketId = 0;//Bug 1433791:add for query burst images by bucketId and DATE_TAKEN
            try {
                ...
                if (cursor != null && cursor.moveToNext()) {
                    ...
                    //Bug 1433791:add for query burst images by bucketId and DATE_TAKEN
                    bucketId = cursor.getInt(
                            cursor.getColumnIndex(MediaStore.Images.ImageColumns.BUCKET_ID));
                } else {
                    finish();
                    return -1;
                }
            ...
            if (dataTaken != null) {
                mLoadImageTask = new LoadImageTask(getContentResolver(), dataTaken, bucketId);
    ...
    class LoadImageTask extends AsyncTask<Void, Void, ArrayList<BurstImageItem>> {
        ...
        public LoadImageTask(ContentResolver c, String dataTaken, int bucketId) {
        ...
        protected ArrayList<BurstImageItem> doInBackground(Void... arg0) {
            ...
            try {
                cursor = mContentResolver.query(MediaStore.Images.Media.EXTERNAL_CONTENT_URI,
                        ...
                        " bucket_id = ? AND datetaken = ? AND (file_flag = ? OR file_flag = ?) ",
                        new String[]{
